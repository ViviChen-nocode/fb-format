...
export const MascotCharacter: React.FC = () => {
  ...
  return (
    <div 
      className="hidden lg:block fixed bottom-0 right-4 z-50 pointer-events-auto select-none"
    ...
    >
      ...
      >
        <div className="glass-card rounded-2xl px-4 py-2 whitespace-nowrap flex items-center gap-2" style={{ borderRadius: 'calc(var(--radius) * 2)' }}>
          <LineIcon className="w-4 h-4 text-[#06C755]" />
          <p className="text-sm font-medium" style={{ color: 'hsl(var(--foreground))' }}>聯繫大師姐</p>
        </div>
        {/* Bubble tail */}
